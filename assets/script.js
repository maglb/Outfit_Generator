...
var autumn = ["long%20sleeve%20top", "jeans", "cardigan", "light%20jacket", "boots"];
...
function getDetails(product) {
    ...
    var itemPrice = product.price.current.text;
    var itemColor = product.colour;
    var itemImg = "https://" + product.additionalImageUrls[0];
